...
import com.viettel.view.control.ConstructionAcceptanceAdapter;
import com.viettel.view.listener.OnEventControlListener;

import java.util.List;

public class Contruction_AcceptancePopup implements OnClickListener{
	...
	private ListView lv_contruction_acceptance;
	private Button btn_contruction_acceptance_choice;
	private ConstructionAcceptanceAdapter acceptanceAdapter;
	private int iWidth = Constants.UNQUALIFY_WIDTH;
	private OnEventControlListener onEvent;
	
	public Contruction_AcceptancePopup(Activity insertActivity,
		...
		layout = (LinearLayout) layoutInflater.inflate(
				R.layout.contruction_acceptance_layout, this.viewGroup, false);
		this.btn_contruction_acceptance_choice = (Button) layout
				.findViewById(R.id.btn_contruction_acceptance_choice);
		this.btn_contruction_acceptance_choice.setOnClickListener(this);
		this.lv_contruction_acceptance = (ListView) layout
				.findViewById(R.id.lv_contruction_acceptance);
		acceptanceAdapter = new ConstructionAcceptanceAdapter(popupActivity,
				listData);
		this.lv_contruction_acceptance.setAdapter(acceptanceAdapter);
...
//				ViewGroup.LayoutParams.MATCH_PARENT, true);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btn_contruction_acceptance_choice:
			onEvent.onEvent(OnEventControlListener.EVENT_ACCEPTANCE_CHOICE, null,
					listData);
			break;
		default:
			break;
