...
public class Cause_Brcd_Sub_Controller {
	public static final String[] allColumn = new String[] {
			Cause_Brcd_Sub_Field.COLUMN_CAUSE_SUBHEADEND_ID,
			Cause_Brcd_Sub_Field.COLUMN_SUPERVISION_SUB_ID,
			Cause_Brcd_Sub_Field.COLUMN_CAT_CAUSE_CONSTR_UNQUALIFY_ID,
			Cause_Brcd_Sub_Field.COLUMN_SYNC_STATUS,
			Cause_Brcd_Sub_Field.COLUMN_IS_ACTIVE,
			Cause_Brcd_Sub_Field.COLUMN_PROCESS_ID,
			Cause_Brcd_Sub_Field.COLUMN_EMPLOYEE_ID,
			Cause_Brcd_Sub_Field.COLUMN_SUPERVISION_CONSTR_ID };
	...
	public static final String CREATE_CAUSE_LINE_BG_TANK_TABLE = "CREATE TABLE IF NOT EXISTS "
			...
			+ Cause_Brcd_Sub_Field.COLUMN_EMPLOYEE_ID
			+ " TEXT,"
			+ Cause_Brcd_Sub_Field.COLUMN_SUPERVISION_CONSTR_ID + " TEXT)";

	public Cause_Brcd_Sub_Controller(Context pContext) {
	...
	public boolean addItem(Cause_Line_BG_TankEntity addItem) {
		...
		values.put(Cause_Brcd_Sub_Field.COLUMN_SUPERVISION_CONSTR_ID,
				addItem.getSupervisionConstrId());

		values.put(Cause_Brcd_Sub_Field.COLUMN_CAUSE_SUBHEADEND_ID,
				addItem.getCause_Line_Bg_Tank_Id());

		values.put(Cause_Brcd_Sub_Field.COLUMN_SUPERVISION_SUB_ID,
				addItem.getSupervision_Line_Bg_Tank_Id());

		values.put(Cause_Brcd_Sub_Field.COLUMN_CAT_CAUSE_CONSTR_UNQUALIFY_ID,
				addItem.getCat_Cause_Constr_Unqualify_Id());

		values.put(Cause_Brcd_Sub_Field.COLUMN_SYNC_STATUS,
				addItem.getSync_Status());

		values.put(Cause_Brcd_Sub_Field.COLUMN_IS_ACTIVE, addItem.getIsActive());

		values.put(Cause_Brcd_Sub_Field.COLUMN_PROCESS_ID,
				addItem.getProcessId());

		values.put(Cause_Brcd_Sub_Field.COLUMN_EMPLOYEE_ID,
				addItem.getEmployeeId());
		// Inserting Row
		idItem = db.insert(Cause_Brcd_Sub_Field.TABLE_NAME, null, values);
	...
	public boolean addItem(Acceptance_Line_Bg_TankEntity addItem) {
		...
		values.put(Acceptance_Brcd_Sub_Field.COLUMN_ACCEPTANCE_SUBHEADEND_ID,
				addItem.getAcceptance_Line_Bg_Tank_Id());

		values.put(Acceptance_Brcd_Sub_Field.COLUMN_SUPERVISION_SUB_ID,
				addItem.getSupervision_Line_Bg_Tank_Id());
		...
		values.put(Acceptance_Brcd_Sub_Field.COLUMN_SYNC_STATUS,
				addItem.getSync_Status());

		values.put(Acceptance_Brcd_Sub_Field.COLUMN_IS_ACTIVE,
				addItem.getIsActive());

		values.put(Acceptance_Brcd_Sub_Field.COLUMN_PROCESS_ID,
				addItem.getProcessId());

		values.put(Acceptance_Brcd_Sub_Field.COLUMN_EMPLOYEE_ID,
				addItem.getEmployeeId());
		// Inserting Row
		idItem = db.insert(Acceptance_Brcd_Sub_Field.TABLE_NAME, null, values);
		KttsDatabaseHelper.INSTANCE.close();
	...
	public boolean delete(Supervision_LBG_UnqualifyItemEntity pDelItem) {
		...
		values.put(Cause_Brcd_Sub_Field.COLUMN_IS_ACTIVE,
				Constants.ISACTIVE.DEACTIVE);

		values.put(Cause_Brcd_Sub_Field.COLUMN_SYNC_STATUS,
				Constants.SYNC_STATUS.ADD);

		String sqlclause = Cause_Brcd_Sub_Field.COLUMN_CAUSE_SUBHEADEND_ID + "= ?";
		String[] sqlPara = new String[] { String.valueOf(pDelItem
				.getCause_Line_Bg_Id()) };
		return this.updateDB(Cause_Brcd_Sub_Field.TABLE_NAME, values, sqlclause,
				sqlPara);
	}
	...
	public boolean deleteAccept(Supervision_LBG_UnqualifyItemEntity pDelItem) {
		...
		String sqlclause = Acceptance_Brcd_Sub_Field.COLUMN_ACCEPTANCE_SUBHEADEND_ID
				+ "= ?";
		String[] sqlPara = new String[] { String.valueOf(pDelItem
				.getCause_Line_Bg_Id()) };
		return this.updateDB(Acceptance_Brcd_Sub_Field.TABLE_NAME, values,
				sqlclause, sqlPara);
	}
	...
	public List<Supervision_LBG_UnqualifyItemEntity> getAllTankUnqulifyByTankId(
		...
		Cursor cursor = db.query(
				...
				allColumn,
				Cause_Brcd_Sub_Field.COLUMN_SUPERVISION_SUB_ID
						+ " = ? AND " + Cause_Brcd_Sub_Field.COLUMN_IS_ACTIVE
						+ "= ?",
	...
	private Supervision_LBG_UnqualifyItemEntity converAcceptToUnqualifyItem(
		...
		try {
			curItem.setCause_Line_Bg_Id(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Brcd_Sub_Field.COLUMN_ACCEPTANCE_SUBHEADEND_ID)));

			curItem.setCat_Cause_Constr_Acceptance_Id(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Brcd_Sub_Field.COLUMN_CAT_CAUSE_CONSTR_ACCEPTANCE_ID)));

			curItem.setSync_Status(cursor.getInt(cursor
					.getColumnIndex(Acceptance_Brcd_Sub_Field.COLUMN_SYNC_STATUS)));

			curItem.setIsActive(cursor.getInt(cursor
					.getColumnIndex(Acceptance_Brcd_Sub_Field.COLUMN_IS_ACTIVE)));

			curItem.setProcessId(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Brcd_Sub_Field.COLUMN_PROCESS_ID)));
	...
	private Supervision_LBG_UnqualifyItemEntity converUnqualifyToUnqualifyItem(
		...
		try {
			curItem.setCause_Line_Bg_Id(cursor.getLong(cursor
					.getColumnIndex(Cause_Brcd_Sub_Field.COLUMN_CAUSE_SUBHEADEND_ID)));

			curItem.setCat_Cause_Constr_Unqualify_Id(cursor.getLong(cursor
					.getColumnIndex(Cause_Brcd_Sub_Field.COLUMN_CAT_CAUSE_CONSTR_UNQUALIFY_ID)));

			curItem.setSync_Status(cursor.getInt(cursor
					.getColumnIndex(Cause_Brcd_Sub_Field.COLUMN_SYNC_STATUS)));

			curItem.setIsActive(cursor.getInt(cursor
					.getColumnIndex(Cause_Brcd_Sub_Field.COLUMN_IS_ACTIVE)));

			curItem.setProcessId(cursor.getLong(cursor
					.getColumnIndex(Cause_Brcd_Sub_Field.COLUMN_PROCESS_ID)));
