...
public class Cause_Brcd_Tn_Controller {
	public static final String[] allColumn = new String[] {
			Cause_Brcd_Tn_Field.COLUMN_CAUSE_BRANCH_CABINET_ID,
			Cause_Brcd_Tn_Field.COLUMN_SUPERVISION_BRANCH_CABINET_ID,
			Cause_Brcd_Tn_Field.COLUMN_CAT_CAUSE_CONSTR_UNQUALIFY_ID,
			Cause_Brcd_Tn_Field.COLUMN_SYNC_STATUS,
			Cause_Brcd_Tn_Field.COLUMN_IS_ACTIVE,
			Cause_Brcd_Tn_Field.COLUMN_PROCESS_ID,
			Cause_Brcd_Tn_Field.COLUMN_EMPLOYEE_ID,
			Cause_Brcd_Tn_Field.COLUMN_SUPERVISION_CONSTR_ID};
	...
	public Cause_Brcd_Tn_Controller(Context pContext) {
	...
	public boolean addItem(Cause_Line_BG_TankEntity addItem) {
		...
		values.put(Cause_Brcd_Tn_Field.COLUMN_SUPERVISION_CONSTR_ID,
				addItem.getSupervisionConstrId());

		values.put(Cause_Brcd_Tn_Field.COLUMN_CAUSE_BRANCH_CABINET_ID,
				addItem.getCause_Line_Bg_Tank_Id());

		values.put(Cause_Brcd_Tn_Field.COLUMN_SUPERVISION_BRANCH_CABINET_ID,
		...
		values.put(Cause_Brcd_Tn_Field.COLUMN_SYNC_STATUS,
				addItem.getSync_Status());

		values.put(Cause_Brcd_Tn_Field.COLUMN_IS_ACTIVE,
				addItem.getIsActive());

		values.put(Cause_Brcd_Tn_Field.COLUMN_PROCESS_ID,
				addItem.getProcessId());

		values.put(Cause_Brcd_Tn_Field.COLUMN_EMPLOYEE_ID,
				addItem.getEmployeeId());
		// Inserting Row
		idItem = db.insert(Cause_Brcd_Tn_Field.TABLE_NAME, null, values);
	...
	public boolean addItem(Acceptance_Line_Bg_TankEntity addItem) {
		...
		values.put(Acceptance_Brcd_Tn_Field.COLUMN_ACCEPTANCE_BRANCH_CABINET_ID,
				addItem.getAcceptance_Line_Bg_Tank_Id());

		values.put(Acceptance_Brcd_Tn_Field.COLUMN_SUPERVISION_BRANCH_CABINET_ID,
				addItem.getSupervision_Line_Bg_Tank_Id());
		...
		values.put(Acceptance_Brcd_Tn_Field.COLUMN_SYNC_STATUS,
				addItem.getSync_Status());

		values.put(Acceptance_Brcd_Tn_Field.COLUMN_IS_ACTIVE,
				addItem.getIsActive());

		values.put(Acceptance_Brcd_Tn_Field.COLUMN_PROCESS_ID,
				addItem.getProcessId());

		values.put(Acceptance_Brcd_Tn_Field.COLUMN_EMPLOYEE_ID,
				addItem.getEmployeeId());
		// Inserting Row
		idItem = db.insert(Acceptance_Brcd_Tn_Field.TABLE_NAME, null, values);
		KttsDatabaseHelper.INSTANCE.close();
	...
	public boolean delete(Supervision_LBG_UnqualifyItemEntity pDelItem) {
		...
		String sqlclause = Cause_Brcd_Tn_Field.COLUMN_CAUSE_BRANCH_CABINET_ID
				+ "= ?";
		String[] sqlPara = new String[] { String.valueOf(pDelItem
				.getCause_Line_Bg_Id()) };
		return this.updateDB(Cause_Brcd_Tn_Field.TABLE_NAME, values,
				sqlclause, sqlPara);
	}
	...
	public boolean deleteAccept(Supervision_LBG_UnqualifyItemEntity pDelItem) {
		...
		String sqlclause = Acceptance_Brcd_Tn_Field.COLUMN_ACCEPTANCE_BRANCH_CABINET_ID
				+ "= ?";
		String[] sqlPara = new String[] { String.valueOf(pDelItem
				.getCause_Line_Bg_Id()) };
		return this.updateDB(Acceptance_Brcd_Tn_Field.TABLE_NAME, values,
				sqlclause, sqlPara);
	}
	...
	public List<Supervision_LBG_UnqualifyItemEntity> getAllTanAcceptByTankId(
		...
		Cursor cursor = db.query(
				...
				new String[] { String.valueOf(iTankId),
						String.valueOf(Constants.ISACTIVE.ACTIVE) }, null,
				null, Acceptance_Brcd_Tn_Field.COLUMN_CAT_CAUSE_CONSTR_ACCEPTANCE_ID, null);
		if (cursor.moveToFirst()) {
			do {
				Supervision_LBG_UnqualifyItemEntity curItem = new Supervision_LBG_UnqualifyItemEntity();
	...
	private Supervision_LBG_UnqualifyItemEntity converAcceptToUnqualifyItem(
		...
		try {
			curItem.setCause_Line_Bg_Id(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Brcd_Tn_Field.COLUMN_ACCEPTANCE_BRANCH_CABINET_ID)));

			curItem.setCat_Cause_Constr_Acceptance_Id(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Brcd_Tn_Field.COLUMN_CAT_CAUSE_CONSTR_ACCEPTANCE_ID)));

			curItem.setSync_Status(cursor.getInt(cursor
					.getColumnIndex(Acceptance_Brcd_Tn_Field.COLUMN_SYNC_STATUS)));

			curItem.setIsActive(cursor.getInt(cursor
					.getColumnIndex(Acceptance_Brcd_Tn_Field.COLUMN_IS_ACTIVE)));

			curItem.setProcessId(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Brcd_Tn_Field.COLUMN_PROCESS_ID)));
	...
	private Supervision_LBG_UnqualifyItemEntity converUnqualifyToUnqualifyItem(
		...
		try {
			curItem.setCause_Line_Bg_Id(cursor.getLong(cursor
					.getColumnIndex(Cause_Brcd_Tn_Field.COLUMN_CAUSE_BRANCH_CABINET_ID)));

			curItem.setCat_Cause_Constr_Unqualify_Id(cursor.getLong(cursor
					.getColumnIndex(Cause_Brcd_Tn_Field.COLUMN_CAT_CAUSE_CONSTR_UNQUALIFY_ID)));

			curItem.setSync_Status(cursor.getInt(cursor
					.getColumnIndex(Cause_Brcd_Tn_Field.COLUMN_SYNC_STATUS)));

			curItem.setIsActive(cursor.getInt(cursor
					.getColumnIndex(Cause_Brcd_Tn_Field.COLUMN_IS_ACTIVE)));

			curItem.setProcessId(cursor.getLong(cursor
					.getColumnIndex(Cause_Brcd_Tn_Field.COLUMN_PROCESS_ID)));
