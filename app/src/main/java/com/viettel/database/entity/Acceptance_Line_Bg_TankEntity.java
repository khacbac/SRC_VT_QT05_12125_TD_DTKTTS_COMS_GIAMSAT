...
public class Acceptance_Line_Bg_TankEntity {
	private long acceptance_Line_Bg_Tank_Id;
	...
	public long getAcceptance_Line_Bg_Tank_Id() {
		return acceptance_Line_Bg_Tank_Id;
	}
	public void setAcceptance_Line_Bg_Tank_Id(long acceptance_Line_Bg_Tank_Id) {
		this.acceptance_Line_Bg_Tank_Id = acceptance_Line_Bg_Tank_Id;
	}
