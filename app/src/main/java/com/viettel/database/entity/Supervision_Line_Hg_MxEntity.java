...
public class Supervision_Line_Hg_MxEntity implements Serializable {
	private static final long serialVersionUID = 1514700693040383842L;
	private long supervision_Line_Hg_Mx_Id;
	...
	public long getSupervision_Line_Hg_Mx_Id() {
		return supervision_Line_Hg_Mx_Id;
	}

	public void setSupervision_Line_Hg_Mx_Id(long supervision_Line_Hg_Mx_Id) {
		this.supervision_Line_Hg_Mx_Id = supervision_Line_Hg_Mx_Id;
	}
