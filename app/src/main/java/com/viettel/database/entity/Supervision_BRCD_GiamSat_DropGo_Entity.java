...
public class Supervision_BRCD_GiamSat_DropGo_Entity implements Serializable {

	private static final long serialVersionUID = -2250749004245738084L;
	private long supervition_branch_design_id;
	private long supervision_dropgo_fiber_id;
	...
	public void setSupervition_branch_design_id(long supervition_branch_design_id) {
		this.supervition_branch_design_id = supervition_branch_design_id;
	}
	public long getSupervision_dropgo_fiber_id() {
		return supervision_dropgo_fiber_id;
	}
	public void setSupervision_dropgo_fiber_id(long supervision_dropgo_fiber_id) {
		this.supervision_dropgo_fiber_id = supervision_dropgo_fiber_id;
	}
