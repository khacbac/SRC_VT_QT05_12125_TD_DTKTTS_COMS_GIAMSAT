...
public class Cause_Line_BG_CableEntity implements Serializable {
	private static final long serialVersionUID = -3433794090226540874L;
	private long cause_Line_Bg_Cable_Id;
	...
	public long getCause_Line_Bg_Cable_Id() {
		return cause_Line_Bg_Cable_Id;
	}

	public void setCause_Line_Bg_Cable_Id(long cause_Line_Bg_Cable_Id) {
		this.cause_Line_Bg_Cable_Id = cause_Line_Bg_Cable_Id;
	}
