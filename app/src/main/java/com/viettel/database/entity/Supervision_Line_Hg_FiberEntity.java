...
public class Supervision_Line_Hg_FiberEntity implements Serializable {
	private static final long serialVersionUID = 731018520635758373L;
	private int stt;
	private int idField;
	private long supervision_Line_Hg_Fiber_Id;
	...
	public Supervision_Line_Hg_FiberEntity() {
	...
	public long getSupervision_Line_Hg_Fiber_Id() {
		return supervision_Line_Hg_Fiber_Id;
	}

	public void setSupervision_Line_Hg_Fiber_Id(
			long supervision_Line_Hg_Fiber_Id) {
		this.supervision_Line_Hg_Fiber_Id = supervision_Line_Hg_Fiber_Id;
	}
