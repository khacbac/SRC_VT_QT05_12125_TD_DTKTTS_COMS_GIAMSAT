...
public class Cause_Line_BG_TankEntity implements Serializable {
	private static final long serialVersionUID = 3228956627530665728L;
	private long cause_Line_Bg_Tank_Id;
	...
	public long getCause_Line_Bg_Tank_Id() {
		return cause_Line_Bg_Tank_Id;
	}

	public void setCause_Line_Bg_Tank_Id(long cause_Line_Bg_Tank_Id) {
		this.cause_Line_Bg_Tank_Id = cause_Line_Bg_Tank_Id;
	}
