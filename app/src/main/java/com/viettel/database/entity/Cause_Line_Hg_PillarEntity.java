...
public class Cause_Line_Hg_PillarEntity {

	private long cause_Line_Hg_Pillar_Id;
	...
	public long getCause_Line_Hg_Pillar_Id() {
		return cause_Line_Hg_Pillar_Id;
	}

	public void setCause_Line_Hg_Pillar_Id(long cause_Line_Hg_Pillar_Id) {
		this.cause_Line_Hg_Pillar_Id = cause_Line_Hg_Pillar_Id;
	}
