...
public class Supervision_BRCD_GiamSat_Kct_Entity implements Serializable {

	private static final long serialVersionUID = -2250749004245738084L;
	private long supervition_trunk_cable_id;
	private long supervision_trunk_cable_fiber_id;

	private int start_section = -1;
	private int end_section = -1;

	private int trunk_cable_code;
	...
	public int getTrunk_cable_code() {
		return trunk_cable_code;
	}

	public void setTrunk_cable_code(int trunk_cable_code) {
		this.trunk_cable_code = trunk_cable_code;
	}

	public long getSupervition_trunk_cable_id() {
		return supervition_trunk_cable_id;
	}

	public void setSupervition_trunk_cable_id(long supervition_trunk_cable_id) {
		this.supervition_trunk_cable_id = supervition_trunk_cable_id;
	}

	public long getSupervision_trunk_cable_fiber_id() {
		return supervision_trunk_cable_fiber_id;
	}

	public void setSupervision_trunk_cable_fiber_id(
			long supervision_trunk_cable_fiber_id) {
		this.supervision_trunk_cable_fiber_id = supervision_trunk_cable_fiber_id;
	}
