...
public class Supervision_Line_Hg_CableGSEntity implements Serializable {
	private static final long serialVersionUID = 8995961285728453747L;
	/* Id loai cong */
	private long idCable = Constants.ID_ENTITY_DEFAULT;
	private long supervision_Line_HangId = Constants.ID_ENTITY_DEFAULT;
	...
	public Supervision_Line_Hg_CableGSEntity() {
	...
	public long getSupervision_Line_HangId() {
		return supervision_Line_HangId;
	}

	public void setSupervision_Line_HangId(long supervision_Line_HangId) {
		this.supervision_Line_HangId = supervision_Line_HangId;
	}
