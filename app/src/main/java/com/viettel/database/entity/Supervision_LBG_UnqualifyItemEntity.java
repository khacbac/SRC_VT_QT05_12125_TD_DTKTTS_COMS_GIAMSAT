...
public class Supervision_LBG_UnqualifyItemEntity implements Serializable {
	...
	public Supervision_LBG_UnqualifyItemEntity() {
	...
	public int getIs_Mandory() {
		return is_Mandory;
	}

	public void setIs_Mandory(int is_Mandory) {
		this.is_Mandory = is_Mandory;
	}
