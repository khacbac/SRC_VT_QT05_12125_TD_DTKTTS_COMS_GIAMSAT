...
public class Acceptance_Brcd_Mx_Controller {
	public static final String[] allColumn = new String[] {
		...
		Acceptance_Brcd_Mx_Field.COLUMN_SYNC_STATUS,
		Acceptance_Brcd_Mx_Field.COLUMN_IS_ACTIVE,
		Acceptance_Brcd_Mx_Field.COLUMN_PROCESS_ID,
		Acceptance_Brcd_Mx_Field.COLUMN_EMPLOYEE_ID};
	...
	public Acceptance_Brcd_Mx_Controller(Context pContext) {
