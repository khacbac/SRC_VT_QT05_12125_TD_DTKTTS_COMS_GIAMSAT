...
public class Cause_Line_BG_TankController {
	public static final String[] allColumn = new String[] {
			Cause_Line_BG_TankField.COLUMN_CAUSE_LINE_BG_TANK_ID,
			Cause_Line_BG_TankField.COLUMN_SUPERVISION_LINE_BG_TANK_ID,
			Cause_Line_BG_TankField.COLUMN_CAT_CAUSE_CONSTR_UNQUALIFY_ID,
			Cause_Line_BG_TankField.COLUMN_SYNC_STATUS,
			Cause_Line_BG_TankField.COLUMN_IS_ACTIVE,
			Cause_Line_BG_TankField.COLUMN_PROCESS_ID,
			Cause_Line_BG_TankField.COLUMN_EMPLOYEE_ID,
			Cause_Line_BG_TankField.COLUMN_SUPERVISION_CONSTR_ID};
	...
	public Cause_Line_BG_TankController(Context pContext) {
	...
	public boolean addItem(Cause_Line_BG_TankEntity addItem) {
		...
		values.put(Cause_Line_BG_TankField.COLUMN_SUPERVISION_CONSTR_ID,
				addItem.getSupervisionConstrId());

		values.put(Cause_Line_BG_TankField.COLUMN_CAUSE_LINE_BG_TANK_ID,
				addItem.getCause_Line_Bg_Tank_Id());

		values.put(Cause_Line_BG_TankField.COLUMN_SUPERVISION_LINE_BG_TANK_ID,
		...
		values.put(Cause_Line_BG_TankField.COLUMN_SYNC_STATUS,
				addItem.getSync_Status());

		values.put(Cause_Line_BG_TankField.COLUMN_IS_ACTIVE,
				addItem.getIsActive());

		values.put(Cause_Line_BG_TankField.COLUMN_PROCESS_ID,
				addItem.getProcessId());

		values.put(Cause_Line_BG_TankField.COLUMN_EMPLOYEE_ID,
				addItem.getEmployeeId());
		// Inserting Row
		idItem = db.insert(Cause_Line_BG_TankField.TABLE_NAME, null, values);
	...
	public boolean addItem(Acceptance_Line_Bg_TankEntity addItem) {
		...
		values.put(Acceptance_Line_Bg_TankField.COLUMN_ACCEPTANCE_LINE_BG_TANK_ID,
				addItem.getAcceptance_Line_Bg_Tank_Id());

		values.put(Acceptance_Line_Bg_TankField.COLUMN_SUPERVISION_LINE_BG_TANK_ID,
				addItem.getSupervision_Line_Bg_Tank_Id());
		...
		values.put(Acceptance_Line_Bg_TankField.COLUMN_SYNC_STATUS,
				addItem.getSync_Status());

		values.put(Acceptance_Line_Bg_TankField.COLUMN_IS_ACTIVE,
				addItem.getIsActive());

		values.put(Acceptance_Line_Bg_TankField.COLUMN_PROCESS_ID,
				addItem.getProcessId());

		values.put(Acceptance_Line_Bg_TankField.COLUMN_EMPLOYEE_ID,
				addItem.getEmployeeId());
		// Inserting Row
		idItem = db.insert(Acceptance_Line_Bg_TankField.TABLE_NAME, null, values);
		KttsDatabaseHelper.INSTANCE.close();
	...
	public boolean delete(Supervision_LBG_UnqualifyItemEntity pDelItem) {
		...
		String sqlclause = Cause_Line_BG_TankField.COLUMN_CAUSE_LINE_BG_TANK_ID
				+ "= ?";
		String[] sqlPara = new String[] { String.valueOf(pDelItem
				.getCause_Line_Bg_Id()) };
		return this.updateDB(Cause_Line_BG_TankField.TABLE_NAME, values,
				sqlclause, sqlPara);
	}
	...
	public boolean deleteAccept(Supervision_LBG_UnqualifyItemEntity pDelItem) {
		...
		String sqlclause = Acceptance_Line_Bg_TankField.COLUMN_ACCEPTANCE_LINE_BG_TANK_ID
				+ "= ?";
		String[] sqlPara = new String[] { String.valueOf(pDelItem
				.getCause_Line_Bg_Id()) };
		return this.updateDB(Acceptance_Line_Bg_TankField.TABLE_NAME, values,
				sqlclause, sqlPara);
	}
	...
	public List<Supervision_LBG_UnqualifyItemEntity> getAllTanAcceptByTankId(
		...
		Cursor cursor = db.query(
				...
				new String[] { String.valueOf(iTankId),
						String.valueOf(Constants.ISACTIVE.ACTIVE) }, null,
				null, Acceptance_Line_Bg_TankField.COLUMN_CAT_CAUSE_CONSTR_ACCEPTANCE_ID, null);
		if (cursor.moveToFirst()) {
			do {
				Supervision_LBG_UnqualifyItemEntity curItem = new Supervision_LBG_UnqualifyItemEntity();
	...
	private Supervision_LBG_UnqualifyItemEntity converAcceptToUnqualifyItem(
		...
		try {
			curItem.setCause_Line_Bg_Id(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Line_Bg_TankField.COLUMN_ACCEPTANCE_LINE_BG_TANK_ID)));

			curItem.setCat_Cause_Constr_Acceptance_Id(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Line_Bg_TankField.COLUMN_CAT_CAUSE_CONSTR_ACCEPTANCE_ID)));

			curItem.setSync_Status(cursor.getInt(cursor
					.getColumnIndex(Acceptance_Line_Bg_TankField.COLUMN_SYNC_STATUS)));

			curItem.setIsActive(cursor.getInt(cursor
					.getColumnIndex(Acceptance_Line_Bg_TankField.COLUMN_IS_ACTIVE)));

			curItem.setProcessId(cursor.getLong(cursor
					.getColumnIndex(Acceptance_Line_Bg_TankField.COLUMN_PROCESS_ID)));
	...
	private Supervision_LBG_UnqualifyItemEntity converUnqualifyToUnqualifyItem(
		...
		try {
			curItem.setCause_Line_Bg_Id(cursor.getLong(cursor
					.getColumnIndex(Cause_Line_BG_TankField.COLUMN_CAUSE_LINE_BG_TANK_ID)));

			curItem.setCat_Cause_Constr_Unqualify_Id(cursor.getLong(cursor
					.getColumnIndex(Cause_Line_BG_TankField.COLUMN_CAT_CAUSE_CONSTR_UNQUALIFY_ID)));

			curItem.setSync_Status(cursor.getInt(cursor
					.getColumnIndex(Cause_Line_BG_TankField.COLUMN_SYNC_STATUS)));

			curItem.setIsActive(cursor.getInt(cursor
					.getColumnIndex(Cause_Line_BG_TankField.COLUMN_IS_ACTIVE)));

			curItem.setProcessId(cursor.getLong(cursor
					.getColumnIndex(Cause_Line_BG_TankField.COLUMN_PROCESS_ID)));
