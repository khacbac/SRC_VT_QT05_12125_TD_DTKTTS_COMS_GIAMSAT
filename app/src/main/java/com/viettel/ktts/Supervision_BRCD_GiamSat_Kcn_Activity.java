...
import com.viettel.view.control.Supervision_BRCD_GS_KCN_Adapter;
 ...
 * 
 */
public class Supervision_BRCD_GiamSat_Kcn_Activity extends HomeBaseActivity {
	/* controll */
	private View spvBRCD_GS_KCNView;
	private ListView lv_constr_brcd_giamsat_kcn_list;
	private TextView tv_constr_brcd_giamsat_kcn_station_code_value,
			tv_constr_brcd_giamsat_kcn_stationcode,
			tv_constr_brcd_keocapnhanh_name,
			tv_constr_brcd_giamsat_keocapnhanh_dropdown;
	private Button bt_giamsat_keocapnhanh_back,
			btn_constr_brcd_giamsat_keocapnhanh_addnew,
			rl_supervision_brcd_giamsat_keocapnhanh_save;
	private ScrollView scroll_brcd_gs_kcn;
...
//	private Image_ViewGalleryPopup imgViewPopup;
	/* Bien co so du lieu */
	private Supervision_BRCD_GiamSat_Kcn_Controller brcd_gs_kcn_Controller = new Supervision_BRCD_GiamSat_Kcn_Controller(
			this);
	private Constr_Construction_EmployeeEntity itemData;
	private long supervition_brcd_id;
	private Supervision_BRCD_Kcn_Entity curEditItem_kcn = new Supervision_BRCD_Kcn_Entity();
	...
	private Supervision_BRCD_Kct_design_Controller brcd_kct_design_Controller = new Supervision_BRCD_Kct_design_Controller(
			this);
	private Supervision_BRCD_Kcn_Controller brcd_kct_Controller = new Supervision_BRCD_Kcn_Controller(
			this);
	private Cause_Brcd_Kcn_Controller causeBrcdKctController = new Cause_Brcd_Kcn_Controller(
			this);
	...
	private List<Supervision_BRCD_GiamSat_Kcn_Entity> listSupervisionGSKCN;

	/* Item be cap dang sua dung popup */
	private Supervision_BRCD_GiamSat_Kcn_Entity curEditItem = null;
	...
	private Supervision_BRCD_GS_KCN_Adapter supervisionGsKcnAdapter;
...
//		setContentView(R.layout.supervision_brcd_giamsat_keocaonhanh_activity);
...
//		setHeader();
	...
	private void initView() {
		spvBRCD_GS_KCNView = addView(R.layout.supervision_brcd_giamsat_keocaonhanh_activity, R.id.rl_supervision_line_bg_tank);
		this.tv_constr_brcd_keocapnhanh_name = (TextView) spvBRCD_GS_KCNView
				.findViewById(R.id.tv_constr_brcd_keocapnhanh_name);
		this.scroll_brcd_gs_kcn = (ScrollView) spvBRCD_GS_KCNView
				.findViewById(R.id.scroll_brcd_gs_kcn);
		this.lv_constr_brcd_giamsat_kcn_list = (ListView) spvBRCD_GS_KCNView
				.findViewById(R.id.lv_constr_brcd_giamsat_kcn_list);

		this.tv_constr_brcd_giamsat_kcn_station_code_value = (TextView) spvBRCD_GS_KCNView
				.findViewById(R.id.tv_constr_brcd_giamsat_kcn_station_code_value);

		this.tv_constr_brcd_giamsat_kcn_stationcode = (TextView) spvBRCD_GS_KCNView
				.findViewById(R.id.tv_constr_brcd_giamsat_kcn_stationcode);
		this.tv_constr_brcd_giamsat_keocapnhanh_dropdown = (TextView) spvBRCD_GS_KCNView
				.findViewById(R.id.tv_constr_brcd_giamsat_keocapnhanh_dropdown);
		this.tv_constr_brcd_giamsat_keocapnhanh_dropdown
				.setOnClickListener(this);
		this.bt_giamsat_keocapnhanh_back = (Button) spvBRCD_GS_KCNView
				.findViewById(R.id.bt_giamsat_keocapnhanh_back);
		this.bt_giamsat_keocapnhanh_back.setOnClickListener(this);
		this.btn_constr_brcd_giamsat_keocapnhanh_addnew = (Button) spvBRCD_GS_KCNView
				.findViewById(R.id.btn_constr_brcd_giamsat_keocapnhanh_addnew);
		this.btn_constr_brcd_giamsat_keocapnhanh_addnew
				.setOnClickListener(this);

		this.rl_supervision_brcd_giamsat_keocapnhanh_save = (Button) spvBRCD_GS_KCNView
				.findViewById(R.id.rl_supervision_brcd_giamsat_keocapnhanh_save);
		this.rl_supervision_brcd_giamsat_keocapnhanh_save
				.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.tv_constr_brcd_giamsat_keocapnhanh_dropdown:
			this.dropdownPopupMenuDesignInfo = new Menu_DropdownPopup(this,
					this.listDesignInfo);
			dropdownPopupMenuDesignInfo.show(v);
			break;
		case R.id.rl_supervision_brcd_giamsat_keocapnhanh_save:

			messageError_Poin = this.checkVailid_Poin(listSupervisionGSKCN);
			messageError = this.checkVailid(listSupervisionGSKCN);
			messageError_image = this.checkVailid_Image(listSupervisionGSKCN);
			...
			break;
		case R.id.btn_constr_brcd_giamsat_keocapnhanh_addnew:
			...
			if (brcd_kcn_design == null) {
				this.showDialog("Bạn chưa nhập thông tin  thiết kế");
				break;
				...
				Supervision_BRCD_GiamSat_Kcn_Entity brcd_gamsat_kcn_Entity = new Supervision_BRCD_GiamSat_Kcn_Entity();
				...
				if (idSupervion == 0) {
					Toast.makeText(Supervision_BRCD_GiamSat_Kcn_Activity.this,
							StringUtil.getString(R.string.text_out_of_key),
							Toast.LENGTH_SHORT).show();

				}
				brcd_gamsat_kcn_Entity.setSupervisionConstrId(itemData
						.getSupervision_Constr_Id());
				brcd_gamsat_kcn_Entity.setEmployeeId(idUser);
				brcd_gamsat_kcn_Entity.setIsActive(Constants.ISACTIVE.ACTIVE);
				brcd_gamsat_kcn_Entity
						.setSync_Status(Constants.SYNC_STATUS.ADD);
				brcd_gamsat_kcn_Entity
						.setSupervition_branch_cable_id(curEditItem_kcn
								.getSupervition_branch_cable_id());
				brcd_gamsat_kcn_Entity
						.setSUPERVISION_BRANCH_CABLE_FIBER_ID(idSupervion);
				brcd_gs_kcn_Controller.addItem(brcd_gamsat_kcn_Entity);
				refreshListView();
			}
			break;
		case R.id.bt_giamsat_keocapnhanh_back:
			Intent it = new Intent(Supervision_BRCD_GiamSat_Kcn_Activity.this,
	...
	private String checkVailid_Image(
			List<Supervision_BRCD_GiamSat_Kcn_Entity> listSupervisionGSKCN) {
		String sReslut = "";
		try {
	...
	private String checkVailid_Poin(
			List<Supervision_BRCD_GiamSat_Kcn_Entity> listSupervisiongiamsatkeocapnhanh) {
		...
		try {
			brcd_kcn_design = brcd_kcn_design_Controller
					.getSupervisionBRCD_Kcn_design(curEditItem_kcn
							.getSupervition_branch_cable_id());
			for (int i = 0; i < listSupervisiongiamsatkeocapnhanh.size(); i++) {
				if (listSupervisiongiamsatkeocapnhanh.get(i).getEnd_section() < listSupervisiongiamsatkeocapnhanh
						.get(i).getStart_section()) {
					sReslut = "Tại đoạn "
							+ (i + 1)
							+ StringUtil
									.getString(R.string.brcd_diemcuoinhohondau);
				} else if (listSupervisiongiamsatkeocapnhanh.get(i)
						.getEnd_section() > brcd_kcn_design.getLength()) {

					sReslut = "Chiều dài đoạn là "
							+ brcd_kcn_design.getLength()
							+ ", bạn đã vượt quá "
							+ (listSupervisiongiamsatkeocapnhanh.get(i)
									.getEnd_section() - brcd_kcn_design
					...
					if (listSupervisiongiamsatkeocapnhanh.get(i)
							.getStart_section() <= listSupervisiongiamsatkeocapnhanh
						...
						sReslut = "Tại đoạn "
								...
								+ " đoạn " + (i);
					} else if (listSupervisiongiamsatkeocapnhanh.get(i - 1)
							.getStart_section() == -1
							&& listSupervisiongiamsatkeocapnhanh.get(i - 1)
									.getEnd_section() == -1) {
						sReslut = StringUtil
	...
	private void setHeader() {
		final Header myActionBar = (Header) spvBRCD_GS_KCNView.findViewById(R.id.actionbar);
		...
		myActionBar.addAction(new Header.Action() {
			@Override
			public void performAction(View view) {
				requestSync(Supervision_BRCD_GiamSat_Kcn_Activity.this);
			}
	...
	public void onEvent(int eventType, View control, Object data) {
		...
		case OnEventControlListener.EVENT_SUPERVISION_BRCD_TN_EDIT:
			this.curEditItem = (Supervision_BRCD_GiamSat_Kcn_Entity) data;
	...
	protected void deleteKct(
			Supervision_BRCD_GiamSat_Kcn_Entity curEditItem_Gs_Kcn) {
		new SaveAsyncTask().execute();
		brcd_gs_kcn_Controller.deleteGSKcnEntity(curEditItem_Gs_Kcn);
...
//			break;
	...
	private void setData() {
		...
		this.curEditItem_kcn = (Supervision_BRCD_Kcn_Entity) bundleData
				.getSerializable(IntentConstants.INTENT_BRCD_KCN);
		this.tv_constr_brcd_giamsat_keocapnhanh_dropdown.setText(GloablUtils
				.getStringBRCDBackgroundInfo(iDesignInfo));
		this.tv_constr_brcd_giamsat_kcn_station_code_value.setText(itemData
				.getStationCode());
		this.tv_constr_brcd_giamsat_kcn_stationcode.setText(itemData
				.getConstrCode());
		this.tv_constr_brcd_keocapnhanh_name.setText(curEditItem_kcn
				.getCable_Code());
		listTankUnqualifyItem = new Cat_Cause_Constr_UnQualifyController(this)
				.getAllUnQualifyItemByName(
						Constants.UNQUALIFY_TYPE.KEO_CAP_NHANH,
						Constants.UNQUALIFY_TYPE.BRCD);

		listTankAcceptanceItem = new Cat_Cause_Constr_AcceptanceController(this)
				.getAllUnQualifyItemByName(
						Constants.ACCEPTANCE_TYPE.KEO_CAP_NHANH,
						Constants.UNQUALIFY_TYPE.BRCD);
	...
	private void refreshListView() {
		...
		listSupervisionGSKCN = new ArrayList<Supervision_BRCD_GiamSat_Kcn_Entity>();

		listSupervisionGSKCN = brcd_gs_kcn_Controller
				.getAllbrcd_kcn(curEditItem_kcn
						.getSupervition_branch_cable_id());

		this.supervisionGsKcnAdapter = new Supervision_BRCD_GS_KCN_Adapter(
				this, listSupervisionGSKCN);
		this.lv_constr_brcd_giamsat_kcn_list
				.setAdapter(supervisionGsKcnAdapter);
		lv_constr_brcd_giamsat_kcn_list
		...
		if (listSupervisionGSKCN.size() != 0) {
			...
			for (Supervision_BRCD_GiamSat_Kcn_Entity curItemSupervisonGS : listSupervisionGSKCN) {
				List<Supervision_LBG_UnqualifyItemEntity> listUnqualifyItem = this.causeBrcdKctController
						.getAllTankUnqulifyByTankId(curItemSupervisonGS
								.getSUPERVISION_BRANCH_CABLE_FIBER_ID());
				...
				for (Supervision_LBG_UnqualifyItemEntity curUnqualifyItem : listUnqualifyItem) {
					List<Supv_Constr_Attach_FileEntity> lstCurAttachFile = this.supvConstrAttachFileController
							.getLstAttachFile(Cause_Brcd_Kcn_Field.TABLE_NAME,
									curUnqualifyItem.getCause_Line_Bg_Id());
					for (Supv_Constr_Attach_FileEntity itemFile : lstCurAttachFile) {
						curUnqualifyItem.getLstAttachFile().add(itemFile);
					}
	...
	private void saveDataTank() {
		...
		for (Supervision_BRCD_GiamSat_Kcn_Entity curItemData : listSupervisionGSKCN) {
			Supervision_BRCD_GiamSat_Kcn_Entity brcd_kct = new Supervision_BRCD_GiamSat_Kcn_Entity();
			...
			brcd_kct.setSupervition_branch_cable_id(curEditItem_kcn
					.getSupervition_branch_cable_id());
			...
			brcd_kct.setSUPERVISION_BRANCH_CABLE_FIBER_ID(curItemData
					.getSUPERVISION_BRANCH_CABLE_FIBER_ID());
			brcd_gs_kcn_Controller.updateSupervisionBRCD_Kcn(
					brcd_kct.getSUPERVISION_BRANCH_CABLE_FIBER_ID(), brcd_kct);
				...
				/* 2. Them moi nguyen nhan khong dat */
					...
					if (curItemData.getStatus() == Constants.SUPERVISION_STATUS.CHUADAT) {
						...
						long iAddCause = Ktts_KeyController
								.getInstance()
								.getKttsNextKey(Cause_Brcd_Kcn_Field.TABLE_NAME);
	...
	private String checkVailid(
		...
		try {
			...
			for (int i = 0; i < listSupervisiongiamsatkeocapnhanh.size(); i++) {
				...
				for (int j = 0; j < listSupervisiongiamsatkeocapnhanh.get(i)
				...
				if (listSupervisiongiamsatkeocapnhanh.get(i).getStatus() == 1) {
					if (listSupervisiongiamsatkeocapnhanh.get(i)
							.getStart_section() == -1) {
				...
				} else if (listSupervisiongiamsatkeocapnhanh.get(i).getStatus() == 0) {
					if (countNnkdCheck < 1) {
						sReslut = StringUtil
