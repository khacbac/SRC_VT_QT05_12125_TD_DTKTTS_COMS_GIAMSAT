...
import com.viettel.view.control.Supervision_BRCD_GS_DROPGO_Adapter;
 ...
 * 
 */
public class Supervision_BRCD_GiamSat_DropGo_Activity extends HomeBaseActivity {
	/* controll */
	private View spvBRCD_GS_DROPGOView;
	private ListView lv_constr_brcd_giamsat_drop_list;
	private ScrollView scroll_brcd_gs_drop;
	private TextView tv_constr_brcd_giamsat_drop_station_code_value,
			tv_constr_brcd_gs_drop_name,
			tv_constr_brcd_giamsat_drop_stationcode,
			tv_constr_brcd_giamsat_drop_dropdown;
	private Button bt_giamsat_drop_back, btn_constr_brcd_giamsat_drop_addnew,
			rl_supervision_brcd_giamsat_drop_save;
...
//	private Image_ViewGalleryPopup imgViewPopup;
	/* Bien co so du lieu */
	private Supervision_BRCD_GiamSat_DropGo_Controller brcd_gs_kcn_Controller = new Supervision_BRCD_GiamSat_DropGo_Controller(
			this);
	...
	private Supervision_BRCD_Kcn_Controller brcd_kct_Controller = new Supervision_BRCD_Kcn_Controller(
			this);
	private Cause_Brcd_Drop_Controller causeBrcdKctController = new Cause_Brcd_Drop_Controller(
			this);
	...
	private List<Supervision_BRCD_GiamSat_DropGo_Entity> listSupervisionGSKCN;

	/* Item be cap dang sua dung popup */
	private Supervision_BRCD_GiamSat_DropGo_Entity curEditItem = null;
	...
	private Supervision_BRCD_GS_DROPGO_Adapter supervisionGsKcnAdapter;
...
//		setContentView(R.layout.supervision_brcd_giamsat_dropgo_activity);
...
//		setHeader();
	...
	private void initView() {
		spvBRCD_GS_DROPGOView = addView(R.layout.supervision_brcd_giamsat_dropgo_activity, R.id.rl_supervision_line_bg_tank);
		this.tv_constr_brcd_gs_drop_name = (TextView) spvBRCD_GS_DROPGOView
				.findViewById(R.id.tv_constr_brcd_gs_drop_name);
		this.scroll_brcd_gs_drop = (ScrollView) spvBRCD_GS_DROPGOView
				.findViewById(R.id.scroll_brcd_gs_drop);
		this.lv_constr_brcd_giamsat_drop_list = (ListView) spvBRCD_GS_DROPGOView
				.findViewById(R.id.lv_constr_brcd_giamsat_drop_list);

		this.tv_constr_brcd_giamsat_drop_station_code_value = (TextView) spvBRCD_GS_DROPGOView
				.findViewById(R.id.tv_constr_brcd_giamsat_drop_station_code_value);

		this.tv_constr_brcd_giamsat_drop_stationcode = (TextView) spvBRCD_GS_DROPGOView
				.findViewById(R.id.tv_constr_brcd_giamsat_drop_stationcode);
		this.tv_constr_brcd_giamsat_drop_dropdown = (TextView) spvBRCD_GS_DROPGOView
				.findViewById(R.id.tv_constr_brcd_giamsat_drop_dropdown);
		this.tv_constr_brcd_giamsat_drop_dropdown.setOnClickListener(this);
		this.bt_giamsat_drop_back = (Button) spvBRCD_GS_DROPGOView
				.findViewById(R.id.bt_giamsat_drop_back);
		this.bt_giamsat_drop_back.setOnClickListener(this);
		this.btn_constr_brcd_giamsat_drop_addnew = (Button) spvBRCD_GS_DROPGOView
				.findViewById(R.id.btn_constr_brcd_giamsat_drop_addnew);
		this.btn_constr_brcd_giamsat_drop_addnew.setOnClickListener(this);

		this.rl_supervision_brcd_giamsat_drop_save = (Button) spvBRCD_GS_DROPGOView
				.findViewById(R.id.rl_supervision_brcd_giamsat_drop_save);
		this.rl_supervision_brcd_giamsat_drop_save.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.rl_supervision_brcd_giamsat_drop_save:
			...
			break;
		case R.id.btn_constr_brcd_giamsat_drop_addnew:
			...
			if (brcd_drop_design == null) {
				...
				Supervision_BRCD_GiamSat_DropGo_Entity brcd_gamsat_kcn_Entity = new Supervision_BRCD_GiamSat_DropGo_Entity();
				...
				if (idSupervion == 0) {
					Toast.makeText(
							Supervision_BRCD_GiamSat_DropGo_Activity.this,
				...
				brcd_gamsat_kcn_Entity
						.setSupervition_branch_design_id(itemData_drop
								.getSupervition_branch_drop_id());
				brcd_gamsat_kcn_Entity
						.setSupervision_dropgo_fiber_id(idSupervion);
				brcd_gs_kcn_Controller.addItem(brcd_gamsat_kcn_Entity);
				refreshListView();
			}
			break;
		case R.id.bt_giamsat_drop_back:
	...
	private String checkVailid_Image(
			List<Supervision_BRCD_GiamSat_DropGo_Entity> listSupervisionGSKCN) {
		String sReslut = "";
		try {
	...
	private String checkVailid(
			List<Supervision_BRCD_GiamSat_DropGo_Entity> listSupervisiongiamdropgo) {
		String sReslut = "";
		try {
			brcd_drop_design = brcd_drop_design_Controller
					.getSupervisionBRCD_Drop_design(itemData_drop
			...
			for (int i = 0; i < listSupervisiongiamdropgo.size(); i++) {
				...
				} else if (listSupervisiongiamdropgo.get(i).getEnd_section() > brcd_drop_design
						.getCable_length()) {

					sReslut = "Chiều dài đoạn là "
							+ brcd_drop_design.getCable_length()
							+ ", bạn đã vượt quá "
							+ (listSupervisiongiamdropgo.get(i)
									.getEnd_section() - brcd_drop_design
									.getCable_length()) + "m tại đoạn "
							+ (i + 1);
	...
	private String checkVailid_Poin(
			List<Supervision_BRCD_GiamSat_DropGo_Entity> listSupervisiongiamsatdropgo) {
		String sReslut = "";
	...
	private void setHeader() {
		final Header myActionBar = (Header) spvBRCD_GS_DROPGOView.findViewById(R.id.actionbar);
		...
		myActionBar.addAction(new Header.Action() {
			@Override
			public void performAction(View view) {
				requestSync(Supervision_BRCD_GiamSat_DropGo_Activity.this);
			}
	...
	public void onEvent(int eventType, View control, Object data) {
		...
		case OnEventControlListener.EVENT_DROPDOWN_ITEM_CLICK:
			...
			if (typeItem.equals(Constants.DROPDOWN_TYPE.DESIGN_SO_TRUC)) {
				...
				if (this.iDesignInfo > 0) {
					this.tv_constr_brcd_giamsat_drop_dropdown
		...
		case OnEventControlListener.EVENT_CHOICE_ACCESS_DAT:
			this.curEditItem = (Supervision_BRCD_GiamSat_DropGo_Entity) data;
			break;
	...
	protected void deleteKct(
			Supervision_BRCD_GiamSat_DropGo_Entity curEditItem_Gs_Kcn) {
		new SaveAsyncTask().execute();
...
//			break;
	...
	private void setData() {
		...
		this.tv_constr_brcd_giamsat_drop_dropdown.setText(GloablUtils
				.getStringBRCDBackgroundInfo(iDesignInfo));
		this.tv_constr_brcd_giamsat_drop_station_code_value.setText(itemData
				.getStationCode());
		this.tv_constr_brcd_giamsat_drop_stationcode.setText(itemData
				.getConstrCode());
		this.tv_constr_brcd_gs_drop_name.setText(itemData_drop.getDrop_code());

		listTankUnqualifyItem = new Cat_Cause_Constr_UnQualifyController(this)
				.getAllUnQualifyItemByName(Constants.UNQUALIFY_TYPE.DROP_GO,
						Constants.UNQUALIFY_TYPE.BRCD);

		listTankAcceptanceItem = new Cat_Cause_Constr_AcceptanceController(this)
				.getAllUnQualifyItemByName(Constants.ACCEPTANCE_TYPE.DROP_GO,
						Constants.UNQUALIFY_TYPE.BRCD);

		this.listDesignInfo = GloablUtils.getListbrcdBackgroundInfo("");
		if (itemData.getConstrProgressId() == Constants.SUPERVISION_PROGRESS.COMPLETED
				|| itemData.getConstrProgressId() == Constants.SUPERVISION_PROGRESS.UNCOMPLETED) {
			this.rl_supervision_brcd_giamsat_drop_save.setVisibility(View.GONE);

			this.btn_constr_brcd_giamsat_drop_addnew.setVisibility(View.GONE);
		}
	...
	private void refreshListView() {
		...
		listSupervisionGSKCN = new ArrayList<Supervision_BRCD_GiamSat_DropGo_Entity>();

		listSupervisionGSKCN = brcd_gs_kcn_Controller
				.getAllbrcd_kcn(itemData_drop.getSupervition_branch_drop_id());

		this.supervisionGsKcnAdapter = new Supervision_BRCD_GS_DROPGO_Adapter(
				this, listSupervisionGSKCN);
		this.lv_constr_brcd_giamsat_drop_list
				.setAdapter(supervisionGsKcnAdapter);
		lv_constr_brcd_giamsat_drop_list
		...
		if (listSupervisionGSKCN.size() != 0) {
			...
			for (Supervision_BRCD_GiamSat_DropGo_Entity curItemSupervisonGS : listSupervisionGSKCN) {
	...
	private void saveDataTank() {
		...
		for (Supervision_BRCD_GiamSat_DropGo_Entity curItemData : listSupervisionGSKCN) {
			Supervision_BRCD_GiamSat_DropGo_Entity brcd_kct = new Supervision_BRCD_GiamSat_DropGo_Entity();
			...
			brcd_kct.setSupervition_branch_design_id(itemData_drop
					.getSupervition_branch_drop_id());
			...
			brcd_kct.setSupervision_dropgo_fiber_id(curItemData
					.getSupervision_dropgo_fiber_id());
			brcd_gs_kcn_Controller.updateSupervisionBRCD_Kcn(
					brcd_kct.getSupervision_dropgo_fiber_id(), brcd_kct);
...
//			closeProgressDialog();
	...
	class SaveAsyncTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if (outOfKey) {
				Toast.makeText(Supervision_BRCD_GiamSat_DropGo_Activity.this,
						StringUtil.getString(R.string.text_out_of_key),
						Toast.LENGTH_SHORT).show();
				closeProgressDialog();
				return;
