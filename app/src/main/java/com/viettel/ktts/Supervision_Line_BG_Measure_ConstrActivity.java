 ...
 * 
 */
public class Supervision_Line_BG_Measure_ConstrActivity extends
		LineBaseActivity {
	private View spvLineBG_Mesure_ConstrView;
...
//		setContentView(R.layout.supervision_line_bg_measure_constr_activity);
...
//		setHeader();
	...
	private void initView() {
		...
		this.tv_constr_line_measure_constr_info_line_value = (TextView) spvLineBG_Mesure_ConstrView
				.findViewById(R.id.tv_constr_line_measure_constr_info_line_value);

		this.tv_constr_line_measure_constr_info_line_station_code_value = (TextView) spvLineBG_Mesure_ConstrView
				.findViewById(R.id.tv_constr_line_measure_constr_info_line_station_code_value);

		this.btn_line_bg_measure_constr_save = (Button) spvLineBG_Mesure_ConstrView
				.findViewById(R.id.btn_line_bg_measure_constr_save);
		this.btn_line_bg_measure_constr_save.setOnClickListener(this);

		this.btn_line_bg_measure_constr_add = (ImageButton) spvLineBG_Mesure_ConstrView
		...
		try {
			...
			for (Supervision_Measure_ConstrEntity curItem : listMeasureConstr) {
				if (curItem.isNew()) {
					...
					itemAdd.setType(Constants.MEASUREMENT_CONSTR_TYPE.MEASURE_LINE_BG);
					...
					if (curItem.isEdited()) {
						...
						// curItem.setSync_Status(Constants.SYNC_STATUS.ADD);
...
//			}
	...
	private void setHeader() {
		final Header myActionBar = (Header) spvLineBG_Mesure_ConstrView.findViewById(R.id.actionbar);
		...
		myActionBar.addAction(new Header.Action() {
			@Override
			public void performAction(View view) {
				requestSync(Supervision_Line_BG_Measure_ConstrActivity.this);
			}
	...
	class SaveAsyncTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
			...
			if (outOfKey) {
				Toast.makeText(Supervision_Line_BG_Measure_ConstrActivity.this,
