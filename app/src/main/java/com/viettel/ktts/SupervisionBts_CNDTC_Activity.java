...
public class SupervisionBts_CNDTC_Activity extends SupervisionBtsBaseActivity {
	...
	public void initComponent() {
		spvBts_KLView = addView(R.layout.supervision_bts_cndtc_activity,
				R.id.rl_login);
		// textview
		supervision_bts_tv_matram = (TextView) spvBts_KLView
				.findViewById(R.id.rl_supervision_bts_equip_tv_matram);
		supervision_bts_tv_mact = (TextView) spvBts_KLView
				.findViewById(R.id.rl_supervision_bts_equip_tv_mact);
		tvDateUpdate = (TextView) spvBts_KLView
				.findViewById(R.id.tv_bts_cndtc_date_update);
		// combobox
		setSupervision_bts_kl_cb_thietke((RelativeLayout) spvBts_KLView
				.findViewById(R.id.rl_supervision_bts_equip_search_thietke));

		supervision_bts_kl_tv_thietke = (TextView) spvBts_KLView
				.findViewById(R.id.rl_supervision_bts_equip_tv_thietke);
		supervision_bts_kl_tv_thietke.setOnClickListener(this);

		// radiobutton
		rdBuilder = (CheckBox) spvBts_KLView
				.findViewById(R.id.rd_bts_cndtc_group_builder);
		rdAssembly = (CheckBox) spvBts_KLView
				.findViewById(R.id.rd_bts_cndtc_group_assembly);
		rdEquiment = (CheckBox) spvBts_KLView
				.findViewById(R.id.rd_bts_cndtc_group_equiment);
	...
	private void setHeader() {
		...
		myActionBar.addAction(new Header.Action() {
			@Override
			public void performAction(View view) {
				requestSync(SupervisionBts_CNDTC_Activity.this);
			}
