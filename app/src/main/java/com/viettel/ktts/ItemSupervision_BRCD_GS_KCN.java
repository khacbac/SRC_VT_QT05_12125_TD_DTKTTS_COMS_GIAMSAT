...
public class ItemSupervision_BRCD_GS_KCN extends RelativeLayout implements
		OnClickListener {
	...
	private Supervision_BRCD_GiamSat_Kcn_Entity supervisionbrcd_tn = new Supervision_BRCD_GiamSat_Kcn_Entity();
	private int countAcceptCheck = 0;
	private int countNnkdCheck = 0;

	public ItemSupervision_BRCD_GS_KCN(Context context) {
		super(context);
	}

	public ItemSupervision_BRCD_GS_KCN(Context context, View rowRoot) {
		super(context);
		initRow(rowRoot);
	...
	public void initRow(View rowRoot) {
		...
		this.rdo_brcd_giamsat_kcn_dat.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				if (rdo_brcd_giamsat_kcn_dat.isChecked()) {
					supervisionbrcd_tn
		...
		this.rdo_brcd_giamsat_kcn_khongdat.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				if (rdo_brcd_giamsat_kcn_khongdat.isChecked()) {
					supervisionbrcd_tn
	...
	public void setData(
			Supervision_BRCD_GiamSat_Kcn_Entity supervision_BRCD_GiamSat_Kcn_Entity,
			int position) {
		supervisionbrcd_tn = supervision_BRCD_GiamSat_Kcn_Entity;
