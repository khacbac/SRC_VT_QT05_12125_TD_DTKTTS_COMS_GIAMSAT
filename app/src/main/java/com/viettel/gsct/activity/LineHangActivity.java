...
//        setContentView(R.layout.activity_bts);
    ...
    private void initViews() {
        ...
        if (infoId == Constants.LINE_HANG_INFO.NHAT_KY_INFO) {
            fragment = BtsNhatkyFragment.newInstance(BtsNhatkyFragment.TYPE_TUYEN_TREO);
        } else if (infoId == Constants.LINE_HANG_INFO.TIEN_DO_INFO) {
            fragment = TruyenDanNgamTiendoFragment.newInstance(TruyenDanNgamTiendoFragment.TYPE_TUYEN_TREO);
        }
