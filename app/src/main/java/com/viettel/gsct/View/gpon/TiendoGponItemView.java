...
public class TiendoGponItemView extends LinearLayout{
    View rootView;
    ...
    public TiendoGponItemView(Context context) {
        super(context);
        init(context);
    }

    public TiendoGponItemView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TiendoGponItemView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        rootView = inflate(context, R.layout.layout_tien_do_item_gpon, this);
