...
public class OAuthClient {
    ...
    throws IOException, OAuthException, URISyntaxException {
        ...
        OutParameterStyle style = (ps == null) ? OutParameterStyle.BODY
                : Enum.valueOf(OutParameterStyle.class, ps.toString());
     ...
     *             the HTTP response status code was not 200 (OK)
     */
    public OAuthMessage invoke(OAuthMessage request,  OutParameterStyle style)
     ...
     */
    public OAuthResponseMessage access(OAuthMessage request,  OutParameterStyle style) throws IOException {
    ...
    public static enum ParameterStyle {
        AUTHORIZATION_HEADER(OutParameterStyle.AUTHORIZATION_HEADER),
        BODY                (OutParameterStyle.BODY),
        QUERY_STRING        (OutParameterStyle.QUERY_STRING);

        public OutParameterStyle getReplacement() {
            return replacement;
        }

        private ParameterStyle(OutParameterStyle replacement) {
            this.replacement = replacement;
        }

        private final OutParameterStyle replacement;
    }
